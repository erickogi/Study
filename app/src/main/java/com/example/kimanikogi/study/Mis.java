...
public class Mis extends AppCompatActivity
    ...
    public void next(int a){
        switch (a){
            case 1:
                pos=1;
                htmlFilename = "mis/1.htm";
                set();
                break;
            case 2:
                pos=2;
                htmlFilename = "mis/2.htm";
                set();
                break;
            case 3:
                pos=3;
                htmlFilename = "mis/3.htm";
                set();
                break;
            case 4:
                pos=4;
                htmlFilename = "mis/4.htm";
                set();
                break;
            case 5:
                pos=5;
                htmlFilename = "mis/5.htm";
                set();
                break;
            case 6:
                pos=6;
                htmlFilename = "mis/6.htm";
                set();
                break;

            default:
                Toast.makeText(Mis.this," End Reached ",Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mis, menu);
        return true;
    }
