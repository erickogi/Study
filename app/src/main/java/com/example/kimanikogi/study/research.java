...
public class research extends AppCompatActivity
    ...
    int pos=1;
    String htmlFilename = "research/1.htm";
    @Override
    ...
    public void next(int a){
        switch (a){
            ...
            case 2:
                pos=2;
                htmlFilename = "research/2.htm";
                set();
                break;
            case 3:
                pos=3;
                htmlFilename = "research/3.htm";
                set();
                break;
            case 4:
                pos=4;
                htmlFilename = "research/4.htm";
                set();
                break;
            case 5:
                pos=5;
                htmlFilename = "research/5.htm";
                set();
                break;
            case 6:
                pos=6;
                htmlFilename = "research/6.htm";
                set();
                break;
            case 7:
                pos=7;
                htmlFilename = "research/7.htm";
                set();
                break;
            case 8:
                pos=8;
                htmlFilename = "research/8.htm";
                set();
                break;
            case 9:
                pos=9;
                htmlFilename = "research/9.htm";
                set();
                break;
            case 10:
                pos=10;
                htmlFilename = "research/10.htm";
                set();
                break;
            case 11:
                pos=11;
                htmlFilename = "research/11.htm";
                set();
                break;
            case 12:
                pos=12;
                htmlFilename = "research/12.htm";
                set();
                break;


            default:
                Toast.makeText(research.this," End Reached ",Toast.LENGTH_SHORT).show();
        }
